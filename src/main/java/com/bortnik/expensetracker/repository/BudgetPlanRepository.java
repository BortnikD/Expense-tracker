...
public interface BudgetPlanRepository extends JpaRepository<BudgetPlan, UUID> {
    ...
    boolean existsByUserIdAndCategoryIdIsNullAndMonthBetween(
            UUID userId,
            LocalDate startMonth,
            LocalDate endMonth
    );

    boolean existsByUserIdAndCategoryIdAndMonthBetween(
            UUID userId,
            UUID categoryId,
            LocalDate startMonth,
            LocalDate endMonth
...
""")
    Page<BudgetPlan> findByUserIdAndSpentAmountExceedsLimit(UUID userId, Pageable pageable);
...
""")
    Page<BudgetPlan> findAllBySpentAmountExceedsLimitAndMonthBetween(
            Pageable pageable,
            LocalDate startMonth,
            LocalDate endMonth
    );

    Page<BudgetPlan> findByUserIdAndMonthBetween(
            UUID userId,
            LocalDate startMonth,
            LocalDate endMonth,
            Pageable pageable
