...
//        when(budgetPlanRepository.existsByUserIdAndCategoryIdIsNullAndMonthBetween(userId, month, month)).thenReturn(false);
...
//        when(budgetPlanRepository.existsByUserIdAndCategoryIdIsNullAndMonthBetween(userId, month, month)).thenReturn(true);
//
